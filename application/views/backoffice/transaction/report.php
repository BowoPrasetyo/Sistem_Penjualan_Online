			...
			<div class="bg-white border-radius-10 border">
				<div class="p-3">
					<div class="float-left">
						<div class="form-group">
							<a href="<?php echo base_url() ?>backoffice/transaction/downloadlaporantransaksi" class="btn btn-info btn-info-gradient">Export Data</a>
						</div>
					</div>
...
<script>
	$(document).ready(function() {
		...
		<?php if ($this->input->get('start') && $this->input->get('end')) { ?>
			url = BASE_URL + 'backoffice/transaction/datatable?start=<?= $this->input->get('start'); ?>&end=<?= $this->input->get('end'); ?>'
		<?php } ?>
