      ...
      <div class="col-md-10 col-lg-7 mx-auto">
        ...
        <div class="bg-white border border-radius-5">
          <div class="p-3">
            ...
            <hr/>
            <form action="<?=base_url('auth/changepassword');?>" method="post" id="form">
            <input type="hidden" id="captcha-validate" value="0">
              <div class="form-group">
                <label for="">
                  <strong>Passowrd Baru</strong>
                </label>
                <input maxlength='8' type="password" name="password1" class="form-control form-search" placeholder="Masukan Password" required autocomplete="off">
			  </div>
			  <div class="form-group">
                <label for="">
                  <strong>Ulangi Passowrd Baru</strong>
                </label>
                <input maxlength='8' type="password" name="password2" class="form-control form-search" placeholder="Ulangi Password" required autocomplete="off">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <button disabled id="btn" class="btn btn-info btn-block btn-lg border-radius-none btn-info-gradient">Perbarui Password</button>
              </div>
              <div>
                <span>
